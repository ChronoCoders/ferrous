...
/// Testnet: RandomX calibrated for 71.5 H/s (seed4: 30.9 + seed1: 40.6) at 150 s block time.
/// target = floor(2^256 / (71.5 × 150)) = floor(2^256 / 10725).
/// Big-endian: 0x00061C4F26B14130... — requires 13 leading zero bits.
/// compact(TESTNET_MAX_TARGET) = 0x1F061C4F (genesis_n_bits in params.rs).
pub const TESTNET_MAX_TARGET: U256 = U256([
    0x06, 0x00, 0x13, 0x14, 0x6B, 0xF2, 0xC4, 0x61, 0x00, 0x30, 0x41, 0xB1, 0x26, 0x4F, 0x1C, 0x06,
    0x00, 0x13, 0x14, 0x6B, 0xF2, 0xC4, 0x61, 0x00, 0x30, 0x41, 0xB1, 0x26, 0x4F, 0x1C, 0x06, 0x00,
]);
