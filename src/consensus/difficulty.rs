...
/// Testnet: RandomX calibrated for 75 H/s combined at 150 s block time.
/// target = floor(2^256 / (75 × 150)) = floor(2^256 / 11250).
/// Big-endian: 0x0005D34EDEE9D609... — requires 13 leading zero bits.
/// compact(TESTNET_MAX_TARGET) = 0x1F05D34E (genesis_n_bits in params.rs).
pub const TESTNET_MAX_TARGET: U256 = U256([
    0xE7, 0xFA, 0xEF, 0x5F, 0xE4, 0x16, 0x91, 0xEC, 0xC2, 0xAD, 0x46, 0x27, 0xE9, 0x25, 0x77, 0x76,
    0xBD, 0xE5, 0x88, 0x40, 0xA6, 0x53, 0xE2, 0xEB, 0x09, 0xD6, 0xE9, 0xDE, 0x4E, 0xD3, 0x05, 0x00,
]);
